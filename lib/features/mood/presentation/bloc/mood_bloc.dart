...
part 'mood_bloc.freezed.dart'; // generated by Freezed
part 'mood_event.dart';        // our events (part of this library)
part 'mood_state.dart';        // our states (part of this library)
...
class MoodBloc extends Bloc<MoodEvent, MoodState> {
  ...
  Future<void> _onFetchHistory(FetchMoodHistory e, Emitter<MoodState> emit) async {
    ...
    final from = e.from ?? now.subtract(const Duration(days: 5));
    final to   = e.to   ?? now;
